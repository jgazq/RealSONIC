...
NEURON	{
	...
	RANGE V_val, alpham_CaLVAst_val, betam_CaLVAst_val, alphah_CaLVAst_val, betah_CaLVAst_val, A_1_val, B_1_val
...
ASSIGNED	{
	...
	V_val (mV)  alpham_CaLVAst_val (/ms)  betam_CaLVAst_val (/ms)  alphah_CaLVAst_val (/ms)  betah_CaLVAst_val (/ms)  A_1_val (nC/cm2)  B_1_val (nC/cm2)  
