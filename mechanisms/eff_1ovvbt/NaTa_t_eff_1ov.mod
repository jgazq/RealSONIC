...
NEURON	{
	...
	RANGE V_val, alpham_NaTat_val, betam_NaTat_val, alphah_NaTat_val, betah_NaTat_val, A_1_val, B_1_val
...
ASSIGNED	{
	...
	V_val (mV)  alpham_NaTat_val (/ms)  betam_NaTat_val (/ms)  alphah_NaTat_val (/ms)  betah_NaTat_val (/ms)  A_1_val (nC/cm2)  B_1_val (nC/cm2)  
