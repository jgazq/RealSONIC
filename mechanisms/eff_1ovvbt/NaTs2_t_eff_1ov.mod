...
NEURON	{
	...
	RANGE V_val, alpham_NaTs2t_val, betam_NaTs2t_val, alphah_NaTs2t_val, betah_NaTs2t_val, A_1_val, B_1_val
...
ASSIGNED	{
	...
	V_val (mV)  alpham_NaTs2t_val (/ms)  betam_NaTs2t_val (/ms)  alphah_NaTs2t_val (/ms)  betah_NaTs2t_val (/ms)  A_1_val (nC/cm2)  B_1_val (nC/cm2)  
