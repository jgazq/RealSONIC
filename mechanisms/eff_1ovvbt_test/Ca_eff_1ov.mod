...
NEURON	{
	...
	POINTER V_table
	POINTER alpham_Ca_table, betam_Ca_table, alphah_Ca_table, betah_Ca_table
	POINTER A_1_table, B_1_table
	RANGE V_val
	RANGE A_1_val, B_1_val
...
ASSIGNED	{
	...
	V_table
	alpham_Ca_table  betam_Ca_table  alphah_Ca_table  betah_Ca_table
	A_1_table  B_1_table
	V_val (mV)
	alpham_Ca_val (/ms)  betam_Ca_val (/ms)  alphah_Ca_val (/ms)  betah_Ca_val (/ms)
	A_1_val (nC/cm2)  B_1_val (nC/cm2)
