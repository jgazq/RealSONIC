...
FUNCTION_TABLE alpham_Ih2(A(kPa), Q(nC/cm2), A1(nC/cm2), B1(nC/cm2)) (/ms)
FUNCTION_TABLE betam_Ih2(A(kPa), Q(nC/cm2), A1(nC/cm2), B1(nC/cm2)) (/ms)
...
DERIVATIVE states	{
	m' = alpham_Ih2(A_t, y, a1, b1) * (1 - m) - betam_Ih2(A_t, y, a1, b1) * m
}

INITIAL{
	update()
	m = alpham_Ih2(A_t, y, a1, b1) / (alpham_Ih2(A_t, y, a1, b1) + betam_Ih2(A_t, y, a1, b1))
}
