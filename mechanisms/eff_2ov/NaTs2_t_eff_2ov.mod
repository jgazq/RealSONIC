...
DERIVATIVE states	{
	m' = alpham_NaTs2t(A_t, y, q1, f1, q2, f2) * (1 - m) - betam_NaTs2t(A_t, y, q1, f1, q2, f2) * m
	h' = alphah_NaTs2t(A_t, y, q1, f1, q2, f2) * (1 - h) - betah_NaTs2t(A_t, y, q1, f1, q2, f2) * h
}

INITIAL{
	update()
	m = alpham_NaTs2t(A_t, y, q1, f1, q2, f2) / (alpham_NaTs2t(A_t, y, q1, f1, q2, f2) + betam_NaTs2t(A_t, y, q1, f1, q2, f2))
	h = alphah_NaTs2t(A_t, y, q1, f1, q2, f2) / (alphah_NaTs2t(A_t, y, q1, f1, q2, f2) + betah_NaTs2t(A_t, y, q1, f1, q2, f2))
}
