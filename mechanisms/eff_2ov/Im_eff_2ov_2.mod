...
DERIVATIVE states	{
	m' = alpham_Im2(A_t, y, q1, f1, q2, f2) * (1 - m) - betam_Im2(A_t, y, q1, f1, q2, f2) * m
}

INITIAL{
	update()
	m = alpham_Im2(A_t, y, q1, f1, q2, f2) / (alpham_Im2(A_t, y, q1, f1, q2, f2) + betam_Im2(A_t, y, q1, f1, q2, f2))
}
