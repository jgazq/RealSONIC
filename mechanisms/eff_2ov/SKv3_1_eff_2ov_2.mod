...
FUNCTION_TABLE alpham_SKv312(A(kPa), Q(nC/cm2), Q1(nC/cm2), phi1(rad), Q2(nC/cm2), phi2(rad)) (/ms)
FUNCTION_TABLE betam_SKv312(A(kPa), Q(nC/cm2), Q1(nC/cm2), phi1(rad), Q2(nC/cm2), phi2(rad)) (/ms)
...
DERIVATIVE states	{
	m' = alpham_SKv312(A_t, y, q1, f1, q2, f2) * (1 - m) - betam_SKv312(A_t, y, q1, f1, q2, f2) * m
}

INITIAL{
	update()
	m = alpham_SKv312(A_t, y, q1, f1, q2, f2) / (alpham_SKv312(A_t, y, q1, f1, q2, f2) + betam_SKv312(A_t, y, q1, f1, q2, f2))
}
