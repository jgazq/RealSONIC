...
FUNCTION_TABLE alpham_SKv31(A(kPa), Q(nC/cm2), A1(nC/cm2), B1(nC/cm2), A2(nC/cm2), B2(nC/cm2)) (/ms)
FUNCTION_TABLE betam_SKv31(A(kPa), Q(nC/cm2), A1(nC/cm2), B1(nC/cm2), A2(nC/cm2), B2(nC/cm2)) (/ms)
...
DERIVATIVE states	{
	m' = alpham_SKv31(A_t, y, a1, b1, a2, b2) * (1 - m) - betam_SKv31(A_t, y, a1, b1, a2, b2) * m
}

INITIAL{
	update()
	m = alpham_SKv31(A_t, y, a1, b1, a2, b2) / (alpham_SKv31(A_t, y, a1, b1, a2, b2) + betam_SKv31(A_t, y, a1, b1, a2, b2))
}
