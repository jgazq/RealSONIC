...
DERIVATIVE states	{
	m' = alpham_NaTat2(A_t, y, q1, f1, q2, f2) * (1 - m) - betam_NaTat2(A_t, y, q1, f1, q2, f2) * m
	h' = alphah_NaTat2(A_t, y, q1, f1, q2, f2) * (1 - h) - betah_NaTat2(A_t, y, q1, f1, q2, f2) * h
}

INITIAL{
	update()
	m = alpham_NaTat2(A_t, y, q1, f1, q2, f2) / (alpham_NaTat2(A_t, y, q1, f1, q2, f2) + betam_NaTat2(A_t, y, q1, f1, q2, f2))
	h = alphah_NaTat2(A_t, y, q1, f1, q2, f2) / (alphah_NaTat2(A_t, y, q1, f1, q2, f2) + betah_NaTat2(A_t, y, q1, f1, q2, f2))
}
