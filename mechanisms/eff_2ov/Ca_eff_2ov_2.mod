...
DERIVATIVE states	{
	m' = alpham_Ca2(A_t, y, q1, f1, q2, f2) * (1 - m) - betam_Ca2(A_t, y, q1, f1, q2, f2) * m
	h' = alphah_Ca2(A_t, y, q1, f1, q2, f2) * (1 - h) - betah_Ca2(A_t, y, q1, f1, q2, f2) * h
}

INITIAL{
	update()
	m = alpham_Ca2(A_t, y, q1, f1, q2, f2) / (alpham_Ca2(A_t, y, q1, f1, q2, f2) + betam_Ca2(A_t, y, q1, f1, q2, f2))
	h = alphah_Ca2(A_t, y, q1, f1, q2, f2) / (alphah_Ca2(A_t, y, q1, f1, q2, f2) + betah_Ca2(A_t, y, q1, f1, q2, f2))
}
