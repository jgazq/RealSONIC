...
# pkldict = tf.read_pickle(r'C:\Users\jgazquez\PySONIC\PySONIC\lookups\test_joa\realneuron_lookups_fs1.00_ds_us_akima.pkl')
# tf.save_gatingplots(pkldict,r'test2\upsampled\akima',A='all',reduced_xrange=False,Cm0=0.01)
...
#                r'C:\Users\jgazquez\PySONIC\PySONIC\lookups\test_joa\upsampled\(3,5,6,33,2,1)\realneuron_lookups_fs1.00_ds_us_cubic.pkl')
...
tf.read_pickle(r'C:\Users\jgazquez\PySONIC\PySONIC\lookups\test_joa\1overtone\realneuron_lookups_32nm_500kHz_[0_140]_fs0.75_1overtones_2024_03_27_15_13_48.pkl',prints=True)