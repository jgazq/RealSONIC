...
FUNCTION_TABLE alpham_NapEt2(A(kPa), Q(nC/cm2)) (mV)
FUNCTION_TABLE betam_NapEt2(A(kPa), Q(nC/cm2)) (mV)
FUNCTION_TABLE alphah_NapEt2(A(kPa), Q(nC/cm2)) (mV)
FUNCTION_TABLE betah_NapEt2(A(kPa), Q(nC/cm2)) (mV)
