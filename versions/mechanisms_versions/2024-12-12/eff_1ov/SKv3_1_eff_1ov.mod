...
FUNCTION_TABLE alpham_SKv31(A(kPa), Q(nC/cm2), Q1(nC/cm2), phi1(rad)) (/ms)
FUNCTION_TABLE betam_SKv31(A(kPa), Q(nC/cm2), Q1(nC/cm2), phi1(rad)) (/ms)
...
DERIVATIVE states	{
	m' = alpham_SKv31(A_t, y, q1, f1) * (1 - m) - betam_SKv31(A_t, y, q1, f1) * m
}

INITIAL{
	update()
	m = alpham_SKv31(A_t, y, q1, f1) / (alpham_SKv31(A_t, y, q1, f1) + betam_SKv31(A_t, y, q1, f1))
}
